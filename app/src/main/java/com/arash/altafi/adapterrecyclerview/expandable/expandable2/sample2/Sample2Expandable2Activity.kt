...
import com.arash.altafi.adapterrecyclerview.databinding.ActivitySample2Expandable2Binding
...
class Sample2Expandable2Activity : AppCompatActivity() {

    private val binding by lazy {
        ActivitySample2Expandable2Binding.inflate(layoutInflater)
    }
    private val itemList = ArrayList<Item>()
    private lateinit var sampleAdapter2: SampleAdapter2
    ...
    private fun init() = binding.apply {
        simpleData()
        sampleAdapter2 = SampleAdapter2(itemList)
        rvSample2.adapter = sampleAdapter2
    }
