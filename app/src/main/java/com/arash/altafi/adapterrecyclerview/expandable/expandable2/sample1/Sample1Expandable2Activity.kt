...
import com.arash.altafi.adapterrecyclerview.databinding.ActivitySample1Expandable2Binding
...
class Sample1Expandable2Activity : AppCompatActivity() {

    private val binding by lazy {
        ActivitySample1Expandable2Binding.inflate(layoutInflater)
    }
    private val itemList = ArrayList<Item>()
    private lateinit var sampleAdapter1: SampleAdapter1
    ...
    private fun init() = binding.apply {
        simpleData()
        sampleAdapter1 = SampleAdapter1(itemList)
        rvSample2.adapter = sampleAdapter1
    }
